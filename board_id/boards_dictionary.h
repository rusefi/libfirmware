...
#define STATIC_BOARD_ID_UNUSED               (STATIC_BOARD_ID_BASE + 12)
...
#define STATIC_BOARD_ID_UAEFI_GM_GEN4        (STATIC_BOARD_ID_BASE + 68)
#define STATIC_BOARD_ID_UAEFI_Z31        (STATIC_BOARD_ID_BASE + 69)
#define STATIC_BOARD_ID_PREMIUM_Q_TEST        (STATIC_BOARD_ID_BASE + 70)
#define STATIC_BOARD_ID_HARLEY54             (STATIC_BOARD_ID_BASE + 71)
